...
At present, tars-java supports the call chain from version 1.6.3, and the cpp version is about to be released. The following is an example of integrated zipkin.
